...
C_BLUE = "#2563eb"     # primary -- data, OLS line
C_PURPLE = "#7c3aed"   # secondary -- second model / Lasso
C_GREEN = "#10b981"    # accent -- projection / "right" fit / Huber
C_AMBER = "#f59e0b"    # warning -- residuals / overfit / outliers
C_GRAY = "#94a3b8"
C_DARK = "#0f172a"
C_LIGHT = "#e2e8f0"
