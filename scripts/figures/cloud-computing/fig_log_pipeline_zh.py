...
ax.text(12.2, 2.7, "可视化", ha="center", va="center",
        fontsize=8.5, color="#6b7280", style="italic")

ax.set_title("可观测性日志流水线",
             fontsize=14, fontweight="bold", color="#1f2937", pad=12)

plt.savefig("/Users/kchen/Desktop/Project/skilltest/fig_log_pipeline_zh.png",
            dpi=160, bbox_inches="tight", facecolor=BG, pad_inches=0.1)
plt.close()
print("Saved fig_log_pipeline_zh.png")
