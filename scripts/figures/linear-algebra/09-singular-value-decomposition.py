...
C_BLUE = "#2563eb"     # primary - input / v1 / first PC
C_PURPLE = "#7c3aed"   # secondary - v2 / second PC
C_GREEN = "#10b981"    # accent - sigma1 u1 (large)
C_AMBER = "#f59e0b"    # warning - sigma2 u2 (small) / truncation
C_GRAY = "#94a3b8"
C_DARK = "#0f172a"
C_LIGHT = "#e2e8f0"
