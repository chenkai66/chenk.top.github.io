...
C_BLUE = "#2563eb"     # primary - function / forward
C_PURPLE = "#7c3aed"   # secondary - gradient / Newton
C_GREEN = "#10b981"    # accent - convex / good
C_AMBER = "#f59e0b"    # warning - non-convex / saddle / GD path
C_RED = "#ef4444"      # error / maximum
C_GRAY = "#94a3b8"
C_DARK = "#0f172a"
C_LIGHT = "#e2e8f0"
