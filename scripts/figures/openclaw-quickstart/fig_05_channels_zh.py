#!/usr/bin/env python3
"""Channel Routing Architecture (ZH)."""
...
# Gateway -> Agent
draw_arrow(ax, 55, 50, 62, 50, label="分发")

# Agent -> LLM
draw_arrow(ax, 78, 50, 85, 50, label="推理")

plt.savefig("/Users/kchen/Desktop/Project/skilltest/fig_05_channels_zh.png",
            dpi=160, bbox_inches="tight", facecolor=BG, pad_inches=0.1)
plt.close()
print("Saved fig_05_channels_zh.png")
