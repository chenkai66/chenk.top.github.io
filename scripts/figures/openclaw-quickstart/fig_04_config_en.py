...
# Title
ax.text(50, 96, "openclaw.json — Configuration Hierarchy",
...
# Level 1 branches: positions spread across the width
branches = [
    (8,  "agent",     BLUE),
    (22, "providers", AMBER),
    (36, "tools",     GREEN),
