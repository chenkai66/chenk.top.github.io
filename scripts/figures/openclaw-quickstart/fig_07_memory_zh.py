...
# Title
ax.text(50, 96, "OpenClaw 记忆系统 — 四层模型",
...
draw_arrow(ax, 42, 74.5, 42, 66, label="压缩触发 memoryFlush",
           label_offset=(10, 0))
draw_arrow(ax, 42, 54.5, 42, 46, label="索引指向文件",
           label_offset=(10, 0))
draw_arrow(ax, 42, 34.5, 42, 26, label="兜底搜索",
           label_offset=(10, 0))
...
plt.savefig("/Users/kchen/Desktop/Project/skilltest/fig_07_memory_zh.png",
            dpi=160, bbox_inches="tight", facecolor=BG, pad_inches=0.1)
plt.close()
print("Saved fig_07_memory_zh.png")
