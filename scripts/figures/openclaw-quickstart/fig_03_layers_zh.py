...
# Title
ax.text(6, 6.65, "OpenClaw 六层架构",
        ha="center", va="center", fontsize=18, fontweight="bold", color="#1f2937")

layers = [
    ("渠道层", "Telegram  |  钉钉  |  微信  |  Web", BLUE),
    ("网关层", "HTTP/WebSocket  |  限流  |  认证", AMBER),
    ("路由 + 会话 + Pi Agent", "", RED),
    ("工具 + 技能", "", PURPLE),
    ("记忆 + ContextEngine", "", GREEN),
    ("LLM 供应商", "DashScope  |  Anthropic  |  OpenAI", BLUE),
]
...
fig.savefig("/Users/kchen/Desktop/Project/skilltest/fig_03_layers_zh.png",
            dpi=160, bbox_inches="tight", facecolor=BG)
plt.close(fig)
print("Done: fig_03_layers_zh.png")
