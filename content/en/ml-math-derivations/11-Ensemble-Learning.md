...
### The variance reduction identity
...
### Why a committee of mediocre voters works
...
### Random Forest: decorrelating the trees
...
### The exponential training-error bound
...
### Why exponential weights? The forward stagewise view
...
### What the pseudo-residuals look like for common losses
...
### Regularisation: the three knobs that actually matter
...
- Hastie, T., Tibshirani, R., & Friedman, J. (2009). *The Elements of Statistical Learning* (2nd ed.). Springer. [Chapter 10](/en/ml-math-derivations/10-semi-naive-bayes-and-bayesian-networks/).
