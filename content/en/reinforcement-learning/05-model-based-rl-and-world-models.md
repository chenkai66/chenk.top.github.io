...
![Reinforcement Learning (5): Model-Based RL and World Models — Chapter overview](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/reinforcement-learning/05-model-based-rl-and-world-models/illustration_1.png)
...
**Prerequisites:** [Parts 1-3](/en/reinforcement-learning/01-fundamentals-and-core-concepts/) (MDPs, value functions, policy gradients, Actor-Critic).
...
![Reinforcement Learning (5): Model-Based RL and World Models — Chapter summary](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/reinforcement-learning/05-model-based-rl-and-world-models/illustration_2.png)
