...
![Reinforcement Learning (2): Q-Learning and Deep Q-Networks (DQN) — Chapter overview](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/reinforcement-learning/02-q-learning-and-dqn/illustration_1.png)
...
**Prerequisites:** [Part 1](/en/reinforcement-learning/01-fundamentals-and-core-concepts/) for MDPs, the Bellman equations, and the temporal-difference (TD) intuition.
...
![Reinforcement Learning (2): Q-Learning and Deep Q-Networks (DQN) — Chapter summary](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/reinforcement-learning/02-q-learning-and-dqn/illustration_2.png)
...
**Next:** [Part 3](/en/reinforcement-learning/03-policy-gradient-and-actor-critic/) introduces **policy gradient** methods and **actor-critic** architectures — the family that handles continuous actions and underlies PPO, SAC, and the policy half of every modern algorithm.
