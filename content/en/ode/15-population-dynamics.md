...
**Prerequisites**: phase-plane analysis from [Chapter 7](/en/ode/07-systems-and-phase-plane/), nonlinear stability from [Chapter 8](/en/ode/08-nonlinear-stability/), and the chapter on [PDEs](/en/ode/13-pde-introduction/) for the spatial section.
