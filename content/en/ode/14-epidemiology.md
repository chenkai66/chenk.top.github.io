...
![Ordinary Differential Equations (14): Epidemic Models and Epidemiology — Chapter overview](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/ode/14-epidemiology/illustration_1.png)
...
**Prerequisites**: phase-plane analysis from [Chapter 7](/en/ode/07-systems-and-phase-plane/), nonlinear stability from [Chapter 8](/en/ode/08-nonlinear-stability/), numerical methods from [Chapter 11](/en/ode/11-numerical-methods/).
...
![Ordinary Differential Equations (14): Epidemic Models and Epidemiology — Chapter summary](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/ode/14-epidemiology/illustration_2.png)
