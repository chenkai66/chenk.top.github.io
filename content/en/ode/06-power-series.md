...
![Ordinary Differential Equations (6): Linear Systems and the Matrix Exponential — Chapter overview](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/ode/06-power-series/illustration_1.png)
...
![Ordinary Differential Equations (6): Linear Systems and the Matrix Exponential — Chapter summary](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/ode/06-power-series/illustration_2.png)
