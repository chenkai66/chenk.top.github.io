...
### Word embeddings: when geometry encodes meaning
...
### PCA via SVD: what production code actually runs
...
### PCA's blind spot, fixed by labels
...
### The dual is where kernels enter
...
### Ridge regression: shrinkage as conditioning
...
### A fully connected layer is one matmul
...
### Batches turn matvecs into matmuls
