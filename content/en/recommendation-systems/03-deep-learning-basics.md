...
![Recommendation Systems (3): Deep Learning Foundations — visual](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/recommendation-systems/03-deep-learning-basics/illustration_1.jpg)
...
- [Part 2 of this series](/en/recommendation-systems/02-collaborative-filtering/) (matrix factorization, implicit vs. explicit feedback).
...
![Recommendation Systems (3): Deep Learning Foundations — visual](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/recommendation-systems/03-deep-learning-basics/illustration_2.jpg)
...
[Part 4 of this series](/en/recommendation-systems/04-ctr-prediction/) covers these in depth.
...
[Part 4 of this series](/en/recommendation-systems/04-ctr-prediction/) takes the next step: **CTR-prediction models that automate the cross-feature engineering Wide & Deep still relies on**, including DeepFM, DCN, xDeepFM, AutoInt, and FiBiNet.
...
| Part | Topic | Link |
|---|---|---|
| 1 | Introduction to Recommendation Systems | [Read Part 1](/en/recommendation-systems/01-fundamentals/) |
| 2 | Collaborative Filtering | [Read Part 2](/en/recommendation-systems/02-collaborative-filtering/) |
| **3** | **Deep Learning Foundations** | **You are here** |
| 4 | CTR Prediction Models | [Read Part 4](/en/recommendation-systems/04-ctr-prediction/) |
| 5 | Embedding Techniques | [Read Part 5](/en/recommendation-systems/05-embedding-techniques/) |
| 6 | Sequential Recommendation | [Read Part 6](/en/recommendation-systems/06-sequential-recommendation/) |
| ... | ... | ... |
| 16 | Industrial Practice and MLOps | [Read Part 16](/en/recommendation-systems/16-industrial-practice/) |
