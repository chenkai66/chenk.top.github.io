...
- Basic PyTorch
- Recommendation fundamentals from [Part 1](/en/recommendation-systems/01-fundamentals/)
- Embedding techniques from [Part 5](/en/recommendation-systems/05-embedding-techniques/) help
...
**Negative sampling.** Implicit-feedback data only has positive interactions, so you sample negatives. Random sampling is the baseline; popularity-weighted and hard-negative mining produce better gradients but cost more (see [Part 5](/en/recommendation-systems/05-embedding-techniques/)).
