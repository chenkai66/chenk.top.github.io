...
![Recommendation Systems (11): Contrastive Learning and Self-Supervised Learning — visual](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/recommendation-systems/11-contrastive-learning/illustration_1.jpg)
...
- Graph neural networks, especially LightGCN ([Part 7](/en/recommendation-systems/07-graph-neural-networks/))
- Embedding spaces and similarity ([Part 5](/en/recommendation-systems/05-embedding-techniques/))
...
![Recommendation Systems (11): Contrastive Learning and Self-Supervised Learning — visual](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/recommendation-systems/11-contrastive-learning/illustration_2.jpg)
...
1. Evaluate offline with a counterfactual estimator (IPS-weighted NDCG) instead of vanilla NDCG. Closes most of the gap.
2. Bucket A/B results by item popularity quintile. SGL usually wins +3--8% CTR in the bottom two quintiles even when the overall metric is flat.
3. Run the test for 14+ days. Cold-start improvements compound: new items that finally get exposure today generate engagement data that improves the next training cycle.
