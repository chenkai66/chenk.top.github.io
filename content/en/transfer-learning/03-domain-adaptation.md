...
Next: [Part 4 — Few-Shot Learning](/en/transfer-learning/04-few-shot-learning/), where we drop the assumption of abundant source data altogether and learn from a handful of examples per class.
