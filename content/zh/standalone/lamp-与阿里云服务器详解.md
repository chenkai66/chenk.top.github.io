...
description: "从安全组、Apache、PHP、MySQL 三件常见踩坑串通一台 ECS，再到 HTTPS、虚拟主机、Discuz 部署与 SLB+RDS 拆分。"
tags:
  - 云服务器
  - Web 部署
  - LAMP
...
[第 4 节](#四层架构)讲过了。原则是：安全组应该让操作系统防火墙看起来多余，操作系统防火墙也应该让安全组看起来多余。任何一道单独都不够。
