...
**复印机类比。** 把复印机的缩放比例调到 150%，原稿上的每个点都会被映射到离中心 1.5 倍远的位置。这就是一种特定的变换——均匀缩放。矩阵可以表示更多类似的“几何机器”：旋转、剪切、反射、投影，以及它们的各种组合。
...
这两条代数规则在几何上有一个很直观的表现，看整数网格怎么变形就明白了。
