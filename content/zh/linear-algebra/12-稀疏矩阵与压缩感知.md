...
- 范数与条件数（[第 10 章](/zh/linear-algebra/10-矩阵范数与条件数/)）  
- 凸优化（[第 11 章](/zh/linear-algebra/11-矩阵微积分与优化/)）  
- SVD 与低秩逼近（[第 9 章](/zh/linear-algebra/09-奇异值分解SVD/)）  
...
| LASSO | $\tfrac12\midX\beta-y\mid^2 + \lambda\mid\beta\mid_1$ | 一次完成回归和特征选择 |
