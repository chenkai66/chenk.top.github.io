...
![线性代数（十六）：深度学习中的线性代数——从全连接到 Transformer — 章节概览图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/linear-algebra/16-深度学习中的线性代数/illustration_1.png)
## 神经网络就是矩阵乘法链
...
![线性代数（十六）：深度学习中的线性代数——从全连接到 Transformer — 章节小结图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/linear-algebra/16-深度学习中的线性代数/illustration_2.png)
