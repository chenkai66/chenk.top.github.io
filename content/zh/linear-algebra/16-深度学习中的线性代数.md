...
>
> **前置知识：** 矩阵微积分（[第 11 章](/zh/linear-algebra/11-矩阵微积分与优化/)）、SVD（[第 9 章](/zh/linear-algebra/09-奇异值分解SVD/)）、经典机器学习（[第 15 章](/zh/linear-algebra/15-机器学习中的线性代数/)）。
