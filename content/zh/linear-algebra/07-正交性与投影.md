...
### 前置知识：
- 点积与范数（[第 1 章](/zh/linear-algebra/01-向量的本质/)）
- 线性无关性与基（[第 2 章](/zh/linear-algebra/02-线性组合与向量空间/)）
- 矩阵与向量乘法及列空间（[第 3 章](/zh/linear-algebra/03-矩阵作为线性变换/)和[第 5 章](/zh/linear-algebra/05-线性方程组与列空间/)）
...
- Golub, G. H. & Van Loan, C. F. (2013). *Matrix Computations*, [第 5 章](/zh/linear-algebra/05-线性方程组与列空间/)。
