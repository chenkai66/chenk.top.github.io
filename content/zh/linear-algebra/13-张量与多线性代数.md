...
![线性代数（十三）：张量与多线性代数——从标量到高维数据立方体 — 章节概览图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/linear-algebra/13-张量与多线性代数/illustration_1.png)
## 从标量到张量：维度的自然扩展
...
![线性代数（十三）：张量与多线性代数——从标量到高维数据立方体 — 章节小结图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/linear-algebra/13-张量与多线性代数/illustration_2.png)
