...
> - 张量在神经网络压缩和推荐系统中的应用
>
> **前置知识：** [第 6 章](/zh/linear-algebra/06-特征值与特征向量/)特征值分解、[第 9 章](/zh/linear-algebra/09-奇异值分解SVD/) SVD、[第 10 章](/zh/linear-algebra/10-矩阵范数与条件数/)矩阵范数
...
- Strang, G. (2019). *Linear Algebra and Learning from Data*，[第 7 章](/zh/linear-algebra/07-正交性与投影/)。
