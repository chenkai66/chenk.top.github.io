...
---
![线性代数（四）：行列式的秘密 — 章节概览图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/linear-algebra/04-行列式的秘密/illustration_1.png)
...
![线性代数（四）：行列式的秘密 — 章节小结图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/linear-algebra/04-行列式的秘密/illustration_2.png)
