...
- [第 2 章](/zh/linear-algebra/02-线性组合与向量空间/)：线性无关
- [第 3 章](/zh/linear-algebra/03-矩阵作为线性变换/)：矩阵作为线性变换
...
![行列式 = 面积缩放因子：单位正方形被矩阵 0 变成一个平行四边形，其面积等于 1。](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/linear-algebra/04-行列式的秘密/fig1_determinant_area.png)
...
![反射把右手系变成左手系；行列式变为 0。](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/linear-algebra/04-行列式的秘密/fig3_orientation.png)
...
![当 0，整个平面被压到一条更低维的子空间上。原来不同的点会被送到同一处。](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/linear-algebra/04-行列式的秘密/fig4_collapse.png)
...
![三维中，0 矩阵将单位立方体映射为平行六面体；1 就是它的体积。](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/linear-algebra/04-行列式的秘密/fig5_volume_3d.png)
...
![两次变换接连作用：每次按自己的行列式倍数缩放面积，合成后的 0 就是两者乘积。](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/linear-algebra/04-行列式的秘密/fig6_product_rule.png)
...
**[第 5 章](/zh/linear-algebra/05-线性方程组与列空间/)：线性方程组与列空间**  
