...
---
![线性代数（十）：矩阵范数与条件数——数值计算的健康体检 — 章节概览图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/linear-algebra/10-矩阵范数与条件数/illustration_1.png)
...
![线性代数（十）：矩阵范数与条件数——数值计算的健康体检 — 章节小结图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/linear-algebra/10-矩阵范数与条件数/illustration_2.png)
