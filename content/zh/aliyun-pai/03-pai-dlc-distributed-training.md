...
![阿里云 PAI 实战（三）：PAI-DLC——分布式训练不再头疼 —— 视觉化](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/aliyun-pai/03-pai-dlc-distributed-training/illustration_1.jpg)
## 文档到底说了什么
...
![阿里云 PAI 实战（三）：PAI-DLC——分布式训练的轻松之道 — visual](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/aliyun-pai/03-pai-dlc-distributed-training/illustration_2.jpg)
