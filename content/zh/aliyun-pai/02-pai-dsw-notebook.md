...
![阿里云 PAI 实战（二）：PAI-DSW——不会吃掉你权重的 Notebook — visual](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/aliyun-pai/02-pai-dsw-notebook/illustration_1.png)
## DSW 到底是什么？
...
![阿里云 PAI 实战（二）：PAI-DSW——不会吃掉你权重的 Notebook — visual](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/aliyun-pai/02-pai-dsw-notebook/illustration_2.png)
