---
title: "Python 工程实践（8）：性能优化 —— 性能分析、缓存与适时收手"
...
Donald Knuth 那句广为流传的名言常被断章取义。完整原文是：“我们应当忽略微小的效率提升，比如 97% 的情况：过早优化是一切罪恶之源。然而，我们也不应放过那至关重要的 3% 中的良机。” 被省略的后半句恰恰是重点所在。性能优化工作并非追求“一切皆快”，而是精准识别那真正影响全局的 3%，并集中资源将其优化。
