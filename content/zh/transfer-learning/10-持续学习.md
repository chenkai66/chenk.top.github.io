...
本文首先从过参数化网络中 SGD 的优化几何特性出发，阐明遗忘是一种结构性现象，而非工程实现上的缺陷。随后依次介绍四类主流方法：正则化、重放、动态架构和元学习。每种方法均从数学原理、直观机制与工程实践三个角度展开分析。最后我会给出一份完整的 EWC 实现代码，直接能在 Permuted MNIST 上跑通。
