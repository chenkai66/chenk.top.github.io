...
这一篇我想老实回答这个问题。对于一般非凸函数，梯度下降唯一能保证的就是 $\nabla f(x_t) \to 0$——它会停在某个**驻点**，但那可能是局部极小、鞍点，甚至局部极大。我们要找的是“在什么额外条件下，能说更强的话”。

已知三个积极结论：

1. **鞍点可以逃**：在“严格鞍点”假设下，加一点点扰动，GD 能在多项式时间里跑到局部极小。鞍点本身是不稳定的——一点点噪声就够了。
2. **PL 条件**：强凸性的弱化版本，过参数化神经网络里常常成立。在 PL 条件下，即使非凸，标准 GD 也线性收敛。
3. **损失景观本身**：足够宽的网络里，**所有局部极小都是全局极小**；SGD 的噪声还会偏向找“平坦的”极小值，而平坦的极小值往往泛化得更好。
