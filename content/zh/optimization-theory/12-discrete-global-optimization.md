...
[第 08 篇](../08-lagrangian-duality-kkt/)（拉格朗日对偶性）、[第 09 篇](../09-interior-point-barrier/)（内点法）中关于 LP/QP 求解器的讨论。其余内容自成体系，无需额外预备知识。
...
### 3 加入基数约束（cardinality constraint）
