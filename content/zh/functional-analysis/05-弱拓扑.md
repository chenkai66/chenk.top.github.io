...
有时候，范数收敛的要求过于严格。在某些情况下，我们需要更宽松的收敛概念。这就引出了弱拓扑和弱-* 拓扑的概念。这两种拓扑在泛函分析中非常重要，特别是在处理无穷维空间时。

接下来，我会介绍这些拓扑的基本定义和性质。
...
*上一篇：[第4部分 — 对偶空间与Hahn-Banach定理](/zh/functional-analysis/04-dual-spaces-hahn-banach/)*

*下一篇：[第6部分 — 有界算子](/zh/functional-analysis/06-bounded-operators/)*