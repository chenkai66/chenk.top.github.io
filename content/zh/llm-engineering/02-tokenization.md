...
![LLM 工程（2）：分词深入 — 视觉化](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/llm-engineering/02-tokenization/illustration_1.png)
...
![图1：BPE 合并树](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/llm-engineering/02-tokenization/fig1_bpe_tree.png)
...
![图4：词汇量与困惑度的关系](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/llm-engineering/02-tokenization/fig4_vocab_perplexity.png)

词表大小 $V$ 是预训练时选的超参数。它在 **embedding 表 FLOPs 和内存** 与 **每文档序列长度** 之间做权衡。

对于一个 $d_{\text{model}} = 4096$ 的 7B 级别模型，具体数字如下：

| 词汇 | 嵌入参数 | 绑定的LM头 | 总嵌入 | 令牌/英文单词 |
|---|---|---|---|---|
...
![LLM 工程（2）：深入探讨分词 —— 可视化](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/llm-engineering/02-tokenization/illustration_2.png)

![图2：不同语言的中日韩文字符膨胀情况](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/llm-engineering/02-tokenization/fig2_cjk_bloat.png)
