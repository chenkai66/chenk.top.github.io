...
![大模型工程（二）：Tokenization 深挖 — visual](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/llm-engineering/02-tokenization/illustration_1.jpg)
## Tokenizer 到底在做什么
...
![大模型工程（二）：分词器，决定你 API 账单一半的隐形选择 — visual](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/llm-engineering/02-tokenization/illustration_2.jpg)
