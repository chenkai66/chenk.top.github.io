...
| Setup | $/Mtok input \vert  $/Mtok output | Notes |
|---|---|---|---|
| Claude-4.5-Sonnet API | $3 \vert  $15 | 高质量 |
| GPT-4o API | $2.50 \vert  $10 | 高质量 |
| Qwen3-Max API | $1.40 \vert  $5.60 | 高质量，更便宜 |
| Gemini-2.5-Pro API | $2.50 \vert  $10 | 高质量，长上下文 |
| DeepSeek-V3 API | $0.14 \vert  $0.28 | 便宜，擅长数学/代码 |
| Self-host Qwen3-32B FP8 (1xH100) | $0.10 \vert  $0.30 | 70% 利用率 |
| Self-host LLaMA-3.3-70B FP8 (2xH100) | $0.30 \vert  $0.90 | 70% 利用率 |
| Self-host Qwen3-235B-A22B (8xH100) | $0.50 \vert  $1.50 | 70% 利用率 |
| Open-router 池化小模型 | $0.15 \vert  $0.50 | 最便宜 |
| Anthropic Batch API (50% 折扣) | $1.50 \vert  $7.50 | 24 小时 SLA |
| OpenAI Batch API (50% 折扣) | $1.25 \vert  $5 | 24 小时 SLA |
