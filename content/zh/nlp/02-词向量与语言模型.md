...
<!-- wanx-hero -->
![自然语言处理（二）：词向量与语言模型 — 配图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/nlp/word-embeddings-lm/illustration_1.jpg)
## 你将学到什么
<!-- wanx-mid -->
![自然语言处理（二）：词向量与语言模型 — 配图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/nlp/word-embeddings-lm/illustration_2.jpg)
