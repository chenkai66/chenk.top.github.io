...
<!-- wanx-hero -->
![自然语言处理（二）：词向量与语言模型 — 章节概览图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/nlp/word-embeddings-lm/illustration_1.png)

---

## 你将学到什么
<!-- wanx-mid -->
![自然语言处理（二）：词向量与语言模型 — 章节小结图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/nlp/word-embeddings-lm/illustration_2.png)
