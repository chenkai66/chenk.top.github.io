...
<!-- wanx-hero -->
![自然语言处理（十二）：前沿技术与实战应用 — 配图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/nlp/frontiers-applications/illustration_1.jpg)
## 你将学到什么
<!-- wanx-mid -->
![自然语言处理（十二）：前沿技术与实战应用 — 配图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/nlp/frontiers-applications/illustration_2.jpg)
...
## 前置知识
![NLP (12): 前沿与实践应用 —— 视觉化](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/nlp/frontiers-applications/illustration_2.jpg)
