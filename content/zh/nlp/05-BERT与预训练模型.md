...
<!-- wanx-hero -->
![自然语言处理（五）：BERT 与预训练模型 — 章节概览图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/nlp/bert-pretrained-models/illustration_1.png)
...
<!-- wanx-mid -->
![自然语言处理（五）：BERT 与预训练模型 — 章节小结图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/nlp/bert-pretrained-models/illustration_2.png)
