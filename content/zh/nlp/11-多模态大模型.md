...
<!-- wanx-hero -->
![自然语言处理（十一）：多模态大模型 — 配图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/nlp/multimodal-nlp/illustration_1.jpg)
## 你将学到什么


<!-- wanx-mid -->
![自然语言处理（十一）：多模态大模型 — 配图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/nlp/multimodal-nlp/illustration_2.jpg)
