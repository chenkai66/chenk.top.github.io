...
<!-- wanx-hero -->
![自然语言处理（十一）：多模态大模型 — 章节概览图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/nlp/multimodal-nlp/illustration_1.png)
...
<!-- wanx-mid -->
![自然语言处理（十一）：多模态大模型 — 章节小结图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/nlp/multimodal-nlp/illustration_2.png)
