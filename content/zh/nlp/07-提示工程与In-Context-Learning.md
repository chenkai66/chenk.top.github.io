---
title: "自然语言处理（七）：提示工程与 In-Context Learning"
...
<!-- wanx-hero -->
![自然语言处理（七）：提示工程与 In-Context Learning — 章节概览图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/nlp/prompt-engineering-icl/illustration_1.png)
