...
<!-- wanx-hero -->
![自然语言处理（一）：NLP入门与文本预处理 — 配图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/nlp/introduction-and-preprocessing/illustration_1.jpg)
## 你将学到什么
<!-- wanx-mid -->
![自然语言处理（一）：NLP入门与文本预处理 — 配图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/nlp/introduction-and-preprocessing/illustration_2.jpg)
