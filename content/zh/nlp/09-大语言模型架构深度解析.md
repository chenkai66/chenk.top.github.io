...
<!-- wanx-hero -->
![自然语言处理（九）：大语言模型架构深度解析 — 配图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/nlp/llm-architecture-deep-dive/illustration_1.png)
## 你将学到什么
<!-- wanx-mid -->
![自然语言处理（九）：大语言模型架构深度解析 — 配图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/nlp/llm-architecture-deep-dive/illustration_2.png)
