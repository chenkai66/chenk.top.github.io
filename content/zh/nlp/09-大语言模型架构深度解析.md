...
<!-- wanx-hero -->
![自然语言处理（九）：大语言模型架构深度解析 — 章节概览图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/nlp/llm-architecture-deep-dive/illustration_1.png)

---

## 你将学到什么
<!-- wanx-mid -->
![自然语言处理（九）：大语言模型架构深度解析 — 章节小结图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/nlp/llm-architecture-deep-dive/illustration_2.png)
...
- 对基础的 Transformer 模块有一定了解（具体可参考 [第四篇 — 注意力机制与 Transformer](/zh/nlp/04-注意力机制与transformer)）。
- 熟悉预训练模型的核心概念（更多内容见 [第五篇 — BERT 与预训练模型](/zh/nlp/05-bert与预训练模型)）。
