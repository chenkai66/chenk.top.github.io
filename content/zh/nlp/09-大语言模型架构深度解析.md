...
<!-- wanx-hero -->
![自然语言处理（九）：大语言模型架构深度解析 — 配图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/nlp/llm-architecture-deep-dive/illustration_1.jpg)
## 你将学到什么
<!-- wanx-mid -->
![自然语言处理（九）：大语言模型架构深度解析 — 配图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/nlp/llm-architecture-deep-dive/illustration_2.jpg)
...
- 对基础的 Transformer 模块有一定了解（具体可参考 [第四篇 — 注意力机制与 Transformer](/en/nlp/attention-transformer/)）。
- 熟悉预训练模型的核心概念（更多内容见 [第五篇 — BERT 与预训练模型](/en/nlp/bert-pretrained-models/)）。
