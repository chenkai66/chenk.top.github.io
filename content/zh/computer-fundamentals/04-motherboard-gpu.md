...
![主板布局图，标注 CPU 直连域与芯片组域](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/computer-fundamentals/04-motherboard-gpu/fig1_motherboard_layout.png)
...
![PCIe 2.0 → 5.0 在 ×1/×4/×16 下的带宽，以及实际设备的带宽需求](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/computer-fundamentals/04-motherboard-gpu/fig2_pcie_generations.png)
...
![传统南北桥架构与现代 PCH 架构对比](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/computer-fundamentals/04-motherboard-gpu/fig7_chipset_evolution.png)
...
![GPU 内部结构：共享 L2 缓存、八个流式多处理器、warp 调度器、CUDA / Tensor / RT 核心](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/computer-fundamentals/04-motherboard-gpu/fig3_gpu_simt.png)
...
![CPU 和 GPU 的架构对比图，以及随任务量增加的性能交叉曲线](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/computer-fundamentals/04-motherboard-gpu/fig4_cpu_vs_gpu.png)
...
![DDR、GDDR、HBM 带宽对比（对数轴）+ 三种封装拓扑示意](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/computer-fundamentals/04-motherboard-gpu/fig5_memory_bandwidth.png)
...
![常见显示接口的有效带宽及“最佳应用场景”对照表](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/computer-fundamentals/04-motherboard-gpu/fig6_display_interfaces.png)
