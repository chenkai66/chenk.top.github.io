...
| --- | --- | --- | --- | --- |
| **热（Hot）** | NVMe SSD | ~30 µs | $110 \mid活跃数据库、工作集 \mid\lvert  **温（Warm）** \rvert SATA SSD \lvert  ~100 µs \rvert $60 \|日志、近期备份、开发环境 \|
| **冷（Cold）** | HDD | ~10 ms | $15 \mid归档、合规数据、旧媒体 \mid\lvert  **归档（Archive）** \rvert 磁带 / 云冷存储 \lvert  秒至小时级 \rvert $3 \|法律留存、监管要求、灾难恢复 \|
