...
| --- | --- | --- | --- | --- |
| **热（Hot）** | NVMe SSD | ~30 µs | $110 \vert  活跃数据库、工作集 \vert 
| **温（Warm）** | SATA SSD | ~100 µs | $60 \vert  日志、近期备份、开发环境 \vert 
| **冷（Cold）** | HDD | ~10 ms | $15 \vert  归档、合规数据、旧媒体 \vert 
| **归档（Archive）** | 磁带 / 云冷存储 | 秒至小时级 | $3 \vert  法律留存、监管要求、灾难恢复 \vert 
