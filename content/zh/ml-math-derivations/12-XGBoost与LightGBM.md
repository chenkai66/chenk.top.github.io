...
![机器学习数学推导（十二）：XGBoost 与 LightGBM — visual](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/ml-math-derivations/12-XGBoost与LightGBM/illustration_1.jpg)
## 你将学到
...
![机器学习数学推导（十二）：XGBoost 与 LightGBM — visual](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/ml-math-derivations/12-XGBoost与LightGBM/illustration_2.jpg)
