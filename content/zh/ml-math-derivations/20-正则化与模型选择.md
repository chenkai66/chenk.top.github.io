...
---
![机器学习数学推导（第 20 篇）：正则化与模型选择 —— 图示](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/ml-math-derivations/20-正则化与模型选择/illustration_1.jpg)
## 本文要点

一个拥有 1 亿参数的网络，用 5 万张图片训练，按经典理论应该会严重过拟合。但现代深度网络偏偏能泛化得很好。这是为什么？答案离不开两点：**正则化**——一系列限制模型容量的技术；以及**泛化理论**——从数学上解释学习何时有效。这篇文章是整个系列的最后一章，我会把之前积累的所有工具——最小二乘、MAP 估计、优化方法、EM 算法、神经网络——都拿出来，直面这个领域最深刻的问题：**机器学习为什么能泛化？**
...
![机器学习数学推导（二十）：正则化与模型选择 — visual](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/ml-math-derivations/20-正则化与模型选择/illustration_2.jpg)
...
*This is the final part of the [ML Mathematical Derivations](/zh/ml-math-derivations/) series. Previous: [Part 19 -- Neural Networks and Backpropagation](/en/ml-math-derivations/19-neural-networks-and-backpropagation). Start from the beginning: [Part 1 -- Introduction](/en/ml-math-derivations/01-introduction-and-mathematical-foundations/).*
