...
一个拥有 1 亿参数的网络，用 5 万张图片训练，按经典理论应该会严重过拟合，但现代深度网络却能很好地泛化。这背后的主要原因有两点：**正则化**——一系列限制模型容量的技术；**泛化理论**——从数学上解释学习何时有效。作为整个系列的最后一章，我将整合之前积累的所有工具——最小二乘、MAP 估计、优化方法、EM 算法、神经网络——来探讨这个领域最深刻的问题：**机器学习为什么能泛化？**
