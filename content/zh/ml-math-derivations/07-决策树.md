...
**一组数字感受熵和信息增益**：14 个样本里有 9 个正、5 个负，则父节点熵
$$H(Y) = -\tfrac{9}{14}\log_2\tfrac{9}{14} - \tfrac{5}{14}\log_2\tfrac{5}{14} \approx 0.940\ \text{比特}.$$
按某个二值特征 $X$ 分裂：$X=0$ 子集（8 样本，6 正 2 负，熵 $\approx 0.811$），$X=1$ 子集（6 样本，3 正 3 负，熵 $= 1.000$）。加权条件熵
$$H(Y\mid X) = \tfrac{8}{14}\cdot 0.811 + \tfrac{6}{14}\cdot 1.000 \approx 0.892,$$
