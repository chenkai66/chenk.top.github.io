...
---
![机器学习数学推导（一）：绪论与数学基础 — 章节概览图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/ml-math-derivations/01-绪论与数学基础/illustration_1.png)
...
![机器学习数学推导（一）：绪论与数学基础 — 章节小结图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/ml-math-derivations/01-绪论与数学基础/illustration_2.png)
