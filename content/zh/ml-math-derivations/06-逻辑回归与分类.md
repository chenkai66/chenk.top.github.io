...
![机器学习数学推导（六）：逻辑回归与分类 — 章节概览图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/ml-math-derivations/06-逻辑回归与分类/illustration_1.png)
...
![机器学习数学推导（六）：逻辑回归与分类 — 章节小结图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/ml-math-derivations/06-逻辑回归与分类/illustration_2.png)
