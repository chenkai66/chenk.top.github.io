---
title: "系统设计（6）：微服务 vs 单体架构——坦诚的权衡分析"
...
这个故事并非孤例。微服务模式已成为业界默认的架构假设，但坦率地说，它对**大多数团队而言是错误的选择**。准确判断微服务何时带来收益、何时反而造成伤害，是系统设计中最重要的判断之一。
...
模块化单体能提供微服务的大部分组织优势（清晰归属、独立开发），却**规避了分布式系统的固有开销**。
