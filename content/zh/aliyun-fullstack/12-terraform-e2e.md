...
series_order: 12
series_total: 12
description: "终极整合：将第 1-11 部分的所有内容编码为 Terraform 模块。VPC、ECS、RDS、OSS、RAM、SLS、Function Compute — 一键部署。加上 GitHub Actions 的 CI/CD 和成本优化。"
...
作为本系列的收官篇，本文将前十一期的所有手动配置封装为可复用的 Terraform 模块，使你能够获得一个开箱即用的生产级 Terraform 项目，仅需一条命令即可让全栈阿里云基础设施就绪。
...
|---|---|---|---|
| ECS (app server) | $86.14/mo \mid$43.07/mo (right-sized) | 50% |
| RDS Primary | $142.35/mo \mid$85.41/mo (1yr subscription) | 40% |
| RDS Replica | $142.35/mo \mid$85.41/mo (1yr subscription) | 40% |
| NAT Gateway | $13.14/mo \mid$13.14/mo | 0% |
| EIPs (x2) | $6.72/mo \mid$6.72/mo | 0% |
| OSS | $1.20/mo \mid$1.20/mo | 0% |
| SLS + FC | $0.00/mo \mid$0.00/mo (free tier) | 0% |
| **Total** | **$412.90/mo** \mid**$234.95/mo** | **43%** |
