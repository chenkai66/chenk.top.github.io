...
| 生命周期：30 天后转为 IA，90 天后归档，365 天后删除 | ~$14 | ~$168 |
...
| **每 GB 传输成本** | ~0.12/GB（互联网） | ~0.04/GB（CDN 对高流量更便宜） |
| **DDoS 防护** | 基本 | CDN 边缘内置 |
| **HTTPS** | 支持 | 通过 CDN 提供免费证书 |
| **缓存控制** | 无 | 可配置 TTL，缓存清除 API |
| **自定义域名** | 支持但无免费 HTTPS | 完全自定义域名+免费 HTTPS |
