...
| 组件 | 规格 | 月费用（估算） |
|---|---|---|
| OpenSearch | 2 LCU, 50GB storage | ~800 RMB ($110) \vert 
| DashScope 嵌入 | 10 万文档 x 50 个令牌，每周重新嵌入 | ~15 RMB ($2) \vert 
| DashScope LLM (查询理解) | 每天 1 万次查询 x 200 个令牌 | ~300 RMB ($42) \vert 
| DTS 从 RDS 同步 | 小实例，持续同步 | ~200 RMB ($28) \vert 
| ECS for Flask API | ecs.c6.large (2C 4G) | ~300 RMB ($42) \vert 
| **Total** | | **~1,615 RMB ($224/month)** \vert 
