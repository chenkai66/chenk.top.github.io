...
![常微分方程（五）：级数解法与特殊函数 — 章节概览图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/ode/05-laplace-transform/illustration_1.png)
...
![常微分方程（五）：级数解法与特殊函数 — 章节小结图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/ode/05-laplace-transform/illustration_2.png)
