...
| 轨道力学 | $\ddot{\mathbf r} = -GM\mathbf r/\|\mathbf r\|^3$ | 偏心率 $e$ |
| 结构动力学 | $M\ddot x + C\dot x + Kx = F$ | 模态阻尼 $\zeta_i$ |
| 流体（管流） | $abla \cdot \boldsymbol\sigma = 0$ → 径向 ODE | Re |
