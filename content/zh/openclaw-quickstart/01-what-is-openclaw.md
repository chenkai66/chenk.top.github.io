...
![OpenClaw 在代理领域中的位置：托管 vs 自托管，聊天应用 vs 你的界面](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/openclaw-quickstart/01-what-is-openclaw/fig1_quadrant.png)
...
![OpenClaw 快速入门 (1)：这个东西到底是什么 —— 图解](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/openclaw-quickstart/01-what-is-openclaw/illustration_2.png)
