...
![OpenClaw 六层架构：渠道 / 网关 / 路由+会话+Pi Agent / 工具+技能 / 记忆+ContextEngine / LLM 供应商](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/openclaw-quickstart/03-architecture/fig1_six_layers.png)
