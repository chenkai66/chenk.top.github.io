...
![Feudal RL:manager 输出隐式目标,worker 基于该目标行动。](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/reinforcement-learning/11-层次化强化学习与元学习/fig11_hierarchy.png)
