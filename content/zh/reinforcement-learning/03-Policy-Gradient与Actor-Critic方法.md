...
![强化学习（三）：Policy Gradient 与 Actor-Critic 方法 — 章节概览图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/reinforcement-learning/03-policy-gradient-and-actor-critic/illustration_1.png)
...
![强化学习（三）：Policy Gradient 与 Actor-Critic 方法 — 章节小结图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/en/reinforcement-learning/03-policy-gradient-and-actor-critic/illustration_2.png)
