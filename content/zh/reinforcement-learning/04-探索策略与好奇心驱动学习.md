...
![ICM 内在好奇模块:特征编码器 + 逆动力学 + 前向动力学,以预测误差作为内在奖励。](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/reinforcement-learning/04-探索策略与好奇心驱动学习/fig04_icm.png)
...
**下一篇:** [第 5 部分](/zh/reinforcement-learning/05-基于模型的强化学习与世界模型/) 介绍 **基于模型的强化学习与世界模型** — 学习环境的可微分模拟器,使智能体能够在每次真实交互中"梦想"成千上万条想象轨迹。
