...
---
![Linux（二）：文件权限：rwx、chmod、chown 与超越它们的机制 — 章节概览图](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/linux/文件权限/illustration_1.png)
...
内核在进行权限检查时并不是简单地“累加匹配的权限位”，而是采用一种**严格的优先级匹配机制**：
