...
用普通神经网络拟合单摆轨迹，虽然训练误差可以很小，但积分几十秒后，预测的摆要么停下，要么加速到逃逸速度。尽管能量应守恒，但网络并不理解“能量”这一概念。问题不在于数据、优化器或网络深度，而在于架构。无约束的 MLP 能表示任何向量场，包括不物理的那些；这些向量场存在微小的系统性偏差，经长时间积分后会被不断放大，最终表现为宏观的能量漂移。
...
3. Liouville 定理、Poincaré 回归——保结构在数值上的意义
