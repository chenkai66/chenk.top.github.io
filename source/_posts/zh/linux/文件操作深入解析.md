...
![重定向：每个 fd 的去向](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/linux/pipelines/fig2_redirection.png)
...
![进程替换：<(cmd) 把命令的 stdout 暴露成一个文件名](https://blog-pic-ck.oss-cn-beijing.aliyuncs.com/posts/zh/linux/pipelines/fig5_process_substitution.png)
