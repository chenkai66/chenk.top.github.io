...
C_BLUE = "#2563eb"      # primary -- BERT / encoder
C_PURPLE = "#7c3aed"    # secondary -- pre-training / variants
C_GREEN = "#10b981"     # accent -- positive / kept tokens
C_AMBER = "#f59e0b"     # warning -- masked / corrupted
C_RED = "#ef4444"
C_GRAY = "#94a3b8"
C_LIGHT = "#e5e7eb"
C_DARK = "#0f172a"
