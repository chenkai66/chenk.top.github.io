...
# Style
# ---------------------------------------------------------------------------
C_BLUE = COLORS["primary"]     # primary -- left pointer / fixed-window
C_PURPLE = COLORS["accent"]   # secondary -- right pointer / contract
C_GREEN = COLORS["success"]    # accent / valid window
